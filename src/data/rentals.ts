...
export const rentals: Rental[] = [
  {
    ...
    en: {
      ...
      metaTitle: 'Concrete Pump Rental in Ray City & Valdosta, GA | All Needs Discount LLC',
      metaDescription: 'Trailer-mounted Mayco C-30HD concrete pump for rent in Ray City, Valdosta, Adel, Tifton, Waycross, and nearby South Georgia communities. Up to 25 yd³/hr, 500 ft reach. Request a quote online.',
    },
    es: {
      ...
      metaTitle: 'Renta de Bomba de Concreto en Ray City y Valdosta, GA | All Needs Discount LLC',
      metaDescription: 'Bomba de concreto Mayco C-30HD sobre trailer en renta para Ray City, Valdosta, Adel, Tifton, Waycross y comunidades cercanas del sur de Georgia. Hasta 25 yd³/h, 150 m de alcance. Solicita cotización en línea.',
    },
  },
  {
    ...
    en: {
      ...
      body: [
        ...
        '14.2 yd³ of capacity — roughly what it takes to gut a couple of rooms or clear a mid-size roof tear-off. Send us your project and we will tell you if one container covers it or if you need a swap partway through.',
      ],
      goodForTitle: 'Good for',
      goodFor: [
      ...
      howItWorks: [
        'Send us your project and site address — we confirm the container is available and give you a rate.',
        'We deliver and place the container at your site on the agreed date, no truck or trailer needed on your end.',
        "Fill it at your own pace. Let us know when you're done and we pick it up — that's it.",
      ],
      ...
      specs: [
        ...
        { label: 'Delivery area', value: 'Ray City, Valdosta, and the broader South Georgia service area' },
      ...
      metaTitle: 'Roll-Off Container & Dumpster Rental in Ray City & Valdosta, GA | All Needs Discount LLC',
      metaDescription: '14.2 yd³ roll-off container rental for Ray City, Valdosta, Adel, Tifton, Waycross, and nearby South Georgia communities. We deliver, you fill it, we haul it away. Request a quote online.',
    },
    es: {
      ...
      body: [
        ...
        '14.2 yd³ de capacidad — más o menos lo que toma vaciar un par de cuartos o un techo mediano. Cuéntanos tu proyecto y te decimos si un contenedor te alcanza o si necesitas un cambio a la mitad.',
      ],
      goodForTitle: 'Ideal para',
      goodFor: [
      ...
      howItWorks: [
        'Cuéntanos tu proyecto y la dirección — confirmamos disponibilidad y te damos la tarifa.',
        'Entregamos y colocamos el contenedor en tu sitio en la fecha acordada, sin que necesites camioneta ni trailer.',
        'Lo llenas a tu ritmo. Avísanos cuando termines y lo recogemos — así de simple.',
      ],
      ...
      specs: [
        ...
        { label: 'Zona de entrega', value: 'Ray City, Valdosta y toda nuestra zona de servicio del sur de Georgia' },
      ...
      metaTitle: 'Renta de Contenedor Roll-Off en Ray City y Valdosta, GA | All Needs Discount LLC',
      metaDescription: 'Contenedor roll-off de 14.2 yd³ en renta para Ray City, Valdosta, Adel, Tifton, Waycross y comunidades cercanas del sur de Georgia. Lo entregamos, lo llenas, lo recogemos. Solicita cotización en línea.',
    },
  },
];
